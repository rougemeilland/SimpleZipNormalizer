...
namespace Utility.IO.StreamFilters
{
    internal class BufferedRandomInputStream<POSITION_T>
        ...
        where POSITION_T : struct, IAdditionOperators<POSITION_T, UInt64, POSITION_T>, ISubtractionOperators<POSITION_T, POSITION_T, UInt64>, ISubtractionOperators<POSITION_T, UInt64, POSITION_T>
    {
