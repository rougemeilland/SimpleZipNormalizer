...
{
    internal class BufferedBasicOutputStream
        : IBasicOutputByteStream
    {
        ...
        public BufferedBasicOutputStream(IBasicOutputByteStream baseStream, Boolean leaveOpen)
            : this(baseStream, _DEFAULT_BUFFER_SIZE, leaveOpen)
        {
        }

        public BufferedBasicOutputStream(IBasicOutputByteStream baseStream, Int32 bufferSize, Boolean leaveOpen)
        {
            try
            {
