...
{
    internal class BufferedBasicInputStream
        : IBasicInputByteStream
    {
        ...
        public BufferedBasicInputStream(IBasicInputByteStream baseStream, Boolean leaveOpen)
            : this(baseStream, _DEFAULT_BUFFER_SIZE, leaveOpen)
        {
        }

        public BufferedBasicInputStream(IBasicInputByteStream baseStream, Int32 bufferSize, Boolean leaveOpen)
        {
            try
            {
