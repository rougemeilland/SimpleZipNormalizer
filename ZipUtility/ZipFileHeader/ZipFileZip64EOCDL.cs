...
namespace ZipUtility.ZipFileHeader
{
    internal class ZipFileZip64EOCDL
    {
        ...
        private ZipFileZip64EOCDL(UInt32 numberOfTheDiskWithTheStartOfTheZip64EndOfCentralDirectory, UInt64 offsetOfTheZip64EndOfCentralDirectoryRecord, UInt32 totalNumberOfDisks)
        {
        ...
        public static ZipFileZip64EOCDL? Parse(ReadOnlySpan<Byte> buffer)
        {
